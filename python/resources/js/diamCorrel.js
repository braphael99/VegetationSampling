//fetching the diameter correlation, r-squared, and linear equation data
fetch('/diamCorrel')
...
.then(data => {
    ...
    document.getElementById('diamHolder').innerText = `The Correlation Coefficient is: ${correlation.toFixed(3)}`
    ...
    document.getElementById("diamRSquared").innerText = `The r-squared (coefficient of determination) value is ${rSquared.toFixed(3)}.`;
    document.getElementById("diamEquation").innerText = `The slope-intercept form equation is y = ${slope.toFixed(3)}x + ${intercept.toFixed(3)}.`;
